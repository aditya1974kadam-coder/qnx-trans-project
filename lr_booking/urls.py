...
urlpatterns = [
    ...
    path('get-consignor-details/<int:consignor_id>/',
     ...
     path('standard-rate/filter/', StandardRateFilterView.as_view(), name='ststandard-rateate-filter'),
