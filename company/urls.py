...
from .views import (
    ...
    StateMasterCreateAPIView, StateMasterFilterView, StateMasterPermanentDeleteAPIView, StateMasterRetrieveAPIView, StateMasterListAPIView,
...
urlpatterns = [
    ...
    path('state/filter/', StateMasterFilterView.as_view(), name='state-filter-lrs'),
