...
from .models import  VehicleParkDispatch,BookingMemo, BookingMemoLRs, Collection,TripBokkingMemos,TripMemo,TripMode,VehicalHireContract,BrokerMasterTrips,BrokerMaster
...
class BookingMemoSerializer(serializers.ModelSerializer):
    ...
    def validate_vehical_no(self, value):
        instance = getattr(self, 'instance', None)

        qs = BookingMemo.objects.filter(
            vehical_no=value,
            memo_mode='OPEN'
        )
