...
urlpatterns = [
    ...
    path('deduction_res/filter/', views.DeductionReasonMasterFilterView.as_view(), name='state-filter-lrs'),
    ...
    ####################### BANK MASTER URLS #######################       api/transactions/

    path("bank-master/list/", views.BankMasterListView.as_view(), name='bank-master-list'),
    path('bank-master/create/', views.CreateBankMasterView.as_view(), name='create-bank'),
    path("bank-master/detail/", views.BankMasterDetailView.as_view(), name='bank-master-detail'),
    path('bank-master/update/', views.UpdateBankMasterView.as_view(), name='update-bank'),
    path('bank-master/soft-delete/', views.SoftDeleteBankMasterView.as_view(), name='soft-delete-bank'),
