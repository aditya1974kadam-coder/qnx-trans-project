...
class PartyBilling(models.Model):
    ...
    advance_amount = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, null=True, blank=True)
...
class BankMaster(models.Model):
    ...
    short_name = models.CharField(max_length=20)   # SBI, HDFC, ICICI
