...
from .serializers import TruckUnloadingReportStatusSerializer,TruckUnloadingReportDetailsSerializer,TruckUnloadingReportSerializer,LocalMemoDeliverySerializer,DeliveryStatementSerializer,CustomerOutstandingSerializer,TURCaseIdSerializer
